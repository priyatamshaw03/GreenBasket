    ...
    return product && (
        <div className="mt-12">
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        <button onClick={()=> addTocart(product._id)} className="w-full py-3.5 rounded-full cursor-pointer font-medium bg-gray-100 text-gray-800/80 hover:bg-gray-200 transition" >
                            Add to Cart
                        </button>
                        <button onClick={()=> {addTocart(product._id); navigate('/cart')}}  className="w-full py-3.5 rounded-full cursor-pointer font-medium bg-green-500 text-white hover:bg-green-600 transition" >
                            Buy now
                        </button>
                    </div>
                </div>
            ...
            <div className='flex flex-col items-center mt-20'>
                ...
                <p className='text-3xl font-medium'>Similar Products</p>
