...
const Footer = () => {
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-24 bg-green-500/6">
      <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500">
        <div>
          <img className="h-10" src={assets.logo} alt="Logo" />
          <p className="max-w-[450px] mt-6">
            {" "}
            We deliver fresh groceries and snacks straight to your door. Trusted
            by thousands of customers, we aim to make your shopping experience simple and
            affordable.
          </p>
