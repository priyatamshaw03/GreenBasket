...
const Newsletter = () => {
  return (
        <div className="flex flex-col items-center justify-center text-center space-y-2 mt-20 pb-14 bg-green-500/30 rounded-2xl px-3 py-14 md:py-18 mx-2 lg:mx-auto my-30">
